<template>
  <div>
    <div class="title" :class="{ 'title-alt': isSidebarOpen }">
      <CIcon :icon="cilGamepad" size="3xl" class="icon"></CIcon>
      <h2 class="title-heading">Vídeo Jogos:</h2>
    </div>
    <GamingFetch v-slot="{ videos }">
...
<script setup>
import GamingFetch from '../components/Gaming/GamingFetch.vue';
